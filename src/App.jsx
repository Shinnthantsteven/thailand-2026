    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="rounded-[1.5rem] bg-white sm:rounded-[2rem] p-5 ring-1 ring-stone-200">
          <div className="flex flex-wrap gap-2 mb-4"><Badge tone="green">{docVisa.type}</Badge><Badge tone="stone">Valid until {docVisa.validUntil}</Badge></div>
          <div className="grid gap-2 text-sm md:grid-cols-2">
            {[['Issued',docVisa.issued],['Valid From',docVisa.validFrom]].map(([label,val])=>
