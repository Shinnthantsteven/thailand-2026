...
const P = {
  ...
  WAT_UMONG:              'https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Wat_Umong_suan_phutthatham_01.jpg/1280px-Wat_Umong_suan_phutthatham_01.jpg',
  ...
  CM_SKYVIEW:             'https://images.unsplash.com/photo-1508009603885-50cf7c579365?auto=format&fit=crop&w=1200&q=80',
  ...
  MAE_KAMPONG:            'https://api.tourismthailand.org/upload/live/content_article/1124-26891.jpeg',
  JING_JAI:               'https://api.tourismthailand.org/upload/live/content_article/25848-27826.png',
  WUA_LAI:                'https://images.unsplash.com/photo-1513639776629-7b61b0ac49cb?auto=format&fit=crop&w=1200&q=80',
  MAE_KHA:                'https://images.unsplash.com/photo-1519452575417-564c1401ecc0?auto=format&fit=crop&w=1200&q=80',
  BAAN_KANG_WAT:          'https://images.unsplash.com/photo-1499092346589-b9b6be3e94b2?auto=format&fit=crop&w=1200&q=80',
  PLUTO_CAFE:             'https://images.unsplash.com/photo-1509042239860-f550ce710b93?auto=format&fit=crop&w=1200&q=80',
  SAI_NGAM:               'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80',
  MAE_WANG:               'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=80',
};
    ...
    days: [
      ...
      },
      {
        ...
        activities: [
          ...
          { time: 'Evening', name: 'Mae Kha Canal walk + street food', note: 'Lights on canal. Say "mai sai moo" (no pork) at every stall.', cost: '฿100', tag: 'food', photoUrl: P.MAE_KHA },
        ],
      },
      {
        ...
        activities: [
          ...
          { time: '6:00pm', name: 'Baan Kang Wat art village', note: '10-min walk from Wat Umong. Studios + garden cafes at dusk.', cost: 'Free', tag: 'free', photoUrl: P.BAAN_KANG_WAT },
          { time: 'Evening', name: 'PLUTO Café Nimman', note: 'Grab ฿60. Space/cosmos interior. Order coffee or mocktail.', cost: '฿200–400', tag: 'paid', photoUrl: P.PLUTO_CAFE },
        ],
      },
      {
  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        activities: [
          { time: '8:00am', name: 'Sai Ngam Hot Springs — half-day tour', note: 'Tour picks up from guesthouse. Crystal mineral pools in forest. Arrive early.', cost: '฿220 + ฿400 tour', tag: 'paid', photoUrl: P.SAI_NGAM },
